...
public class ABBreakthroughPlayerThreading extends GamePlayer {
	...
	public ABBreakthroughPlayerThreading(String nname, int d)
	{ 
	...
	{
		int depth = 6;
		GamePlayer p = new ABBreakthroughPlayerThreading("Normal", depth);
